...
const ROWS = [
  ...
  ['crossfit', 'CrossFit / functional training', 'crossfit|functional training|wod|metcon', 8.0, 'strength cardio vigorous', 45],
  ['circuit_training', 'Circuit training', 'circuits|circuit training|bootcamp', 7.5, 'strength cardio vigorous', 45],
  ...
  ['padel', 'Padel / squash', 'padel|squash|racquetball', 7.3, 'cardio vigorous', 45],
